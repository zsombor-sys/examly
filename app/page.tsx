          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              <div>
                ...
                <h3 className="mt-3 text-3xl font-semibold tracking-tight">Simple subscription. No surprises.</h3>
                <p className="mt-3 text-white/70 max-w-[58ch]">
                  €6/month for unlimited uploads, unlimited plans, and PDF exports. (Checkout scaffold: Stripe hooks next)
                </p>
              </div>
              <Link href="/billing"><Button className="gap-2">Upgrade to Pro <ArrowRight size={16} /></Button></Link>
            </div>
          </div>
