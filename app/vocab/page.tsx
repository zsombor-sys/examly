...
import { canUse, consume, formatReset, isAdminUser } from '@/lib/freeLimits'
...
export default function VocabPage() {
  ...
  async function generate() {
    ...
    const lim = canUse('vocab')
    if (!lim.ok) {
      setError(`Free limit reached. Resets in ${formatReset(lim.resetAt)}. Upgrade to Pro for unlimited vocab sets.`)
      return
    }
    ...
    try {
      ...
      const res = await fetch('/api/vocab', { method: 'POST', body: fd })
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 text-white/70 max-w-[70ch]">
            Paste a word list or upload a photo of your vocab sheet. Examly turns it into flashcards you can actually use. Supports 6 languages: HU, EN, DE, ES, IT, LA.
          </p>
